# Noctics (legacy Python stack)

This folder freezes the Python implementation as an artifact while new work
moves to Rust/Zig (process-based, no HTTP). Keep it runnable via:

...
register_logo_preset("nano", PLACEHOLDER_LOGO)
register_logo_preset("micro", PLACEHOLDER_LOGO)
register_logo_preset("milli", PLACEHOLDER_LOGO)
register_logo_preset("centi", NOX_LOGO)
...
HUD_LAYOUT: Dict[str, Any] = {
    ...
    "sections": [
        ...
        {"label": "Scale", "value": "{persona_scale}"},
        {"label": "Variant", "value": "{persona_variant_display}"},
